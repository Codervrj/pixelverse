  ...
  return (
    <div className="pt-12 pb-32 px-6 md:px-10 bg-[#F5F5DC] text-black relative overflow-hidden cursor-none">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <h2 className="text-black font-archivo text-4xl md:text-7xl mb-16 text-center tracking-tighter uppercase cursor-target">FAQ</h2>
            ...
            <div key={idx}>
              ...
              <AnimatePresence>
                {open === idx && (
                  ...
                  >
                    <div className="bg-[#FFD700] text-black p-6 font-archivo font-medium text-base md:text-lg border-x-2 border-b-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] mt-2 cursor-target">
                      {faq.a}
                    </div>
                  </motion.div>
                )}
