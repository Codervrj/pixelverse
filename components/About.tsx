...
const About: React.FC = () => {
  return (
    ...
    >
      <div className="max-w-[1600px] mx-auto">
        <div className="flex flex-col lg:grid lg:grid-cols-12 gap-16 lg:gap-12 xl:gap-24 items-start">
  ...
  "
          ...
          <div className="w-full lg:col-span-7 xl:col-span-6 lg:pt-16 xl:pt-30">
            <div className="space-y-12 xl:space-y-16">
              ...
              {/* <p className="text-2xl sm:text-4xl lg:text-[2.8vw] xl:text-5xl font-archivo font-bold leading-[1.1] tracking-tight text-black uppercase max-w-full lg:max-w-[90%]">
                ...
                <span className="inline-block text-[#FFD700] bg-black px-2 py-1 italic my-1">
                  Design Hackathon
                </span>
                <span className="mx-2">&</span> battleground where Form doesn't
                just follow Function - it{" "}
                <span className="underline decoration-4 decoration-[#FFD700]">
                  Elevates it
                </span>
                .
              </p> */}
              ...
              <p
                className="
  text-[clamp(1.1rem,2.5vw,2.2rem)]
...
"
              ...
              <div className="pt-10 border-t-4 border-black flex flex-wrap gap-x-12 gap-y-8 lg:gap-x-8 xl:gap-x-20">
                <motion.div
                  ...
                  className="min-w-fit"
                >
                  <div className="text-[10px] font-bold font-archivo text-black mb-2 uppercase tracking-widest opacity-60">
                    MAX_PARTICIPANTS
                  </div>
