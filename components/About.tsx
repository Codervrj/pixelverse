...
const About: React.FC = () => {
  return (
    <section 
      id="about" 
      className="relative py-32 md:py-48 xl:py-64 px-8 md:px-16 xl:px-24 bg-white text-black border-t-2 border-black cursor-none"
    >
      <div className="max-w-[1800px] mx-auto">
        <div className="flex flex-col lg:grid lg:grid-cols-12 gap-16 lg:gap-24 items-start">

          <div className="w-full lg:col-span-6">
            <div className="inline-block px-5 py-2 bg-[#FFD700] text-black font-archivo font-bold text-xs mb-8 lg:mb-12 uppercase tracking-[0.2em] border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] cursor-target">
              MISSION_LOG: 001
            </div>
            <motion.h2
              ...
              className="text-7xl sm:text-8xl md:text-9xl lg:text-[10vw] xl:text-[11rem] font-archivo leading-[0.8] tracking-tighter uppercase mb-12 text-black cursor-target"
            >
          ...
          <div className="w-full lg:col-span-6 lg:pt-32 xl:pt-48">
            <div className="space-y-16 xl:space-y-24">
              <p className="text-3xl sm:text-4xl md:text-5xl lg:text-4xl xl:text-6xl font-medium leading-[1.1] tracking-tight text-black uppercase max-w-3xl font-archivo cursor-target">
